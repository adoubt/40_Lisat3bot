...
async def chart_ready_callback_handler(clb: CallbackQuery, **kwargs):
    ...
    await clb.message.edit_media(
        media=InputMediaPhoto(
            ...
            caption=f"👉 <b>{pair_name}</b>\n\n<b>Enter your trade amount. Enter the amount according to proper <a href='https://telegra.ph/MONEY-MANAGEMENT-OR-HOW-NOT-TO-LOSE-THE-ENTIRE-DEPOSIT-10-14'>money-management</a></b>",
            parse_mode="HTML",
        ),
